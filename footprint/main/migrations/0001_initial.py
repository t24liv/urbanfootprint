# Generated by Django 5.0.7 on 2025-02-02 14:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_keys', picklefield.fields.PickledObjectField(default=list, editable=False)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style_value_contexts', picklefield.fields.PickledObjectField(default=list, editable=False)),
        ...
        migrations.AddField(
            ...
            name='examples',
            field=models.ManyToManyField(to='main.builtformexample'),
        ),
        migrations.CreateModel(
            name='BuiltFormSet',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuration', picklefield.fields.PickledObjectField(default=dict, editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('superiors', models.ManyToManyField(related_name='subordinates', to='auth.group')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='configentity',
            name='media',
            field=models.ManyToManyField(to='main.medium'),
        ),
        migrations.AddField(
            model_name='builtform',
            name='media',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style_attributes', models.ManyToManyField(to='main.styleattribute')),
            ],
            bases=('main.medium',),
        ),
        migrations.CreateModel(
